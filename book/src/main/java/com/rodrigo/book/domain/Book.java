package com.rodrigo.book.domain;
...
public class Book {
	...
	public Book(String titulo, String descricao, double preco, Boolean digital, Boolean disponivel,
			Date dataDisponivel) {
		this.titulo = titulo;
	...
	public Book(Long id, String titulo, String descricao, Double preco, Boolean digital, Boolean disponivel,
			Date dataDisponivel) {
		this.id = id;
		this.titulo = titulo;
		this.descricao = descricao;
